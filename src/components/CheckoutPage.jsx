            ...
            <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                ...
                <div className="px-4 space-y-5 text-center">
                    <p className="text-[17px] text-orange-500">
                        This purchase will allow you to access our magazine hard copy
                        on our platform 
                    ...
                    <button type="submit" className="bg-orange-500 text-orange-50 hover:bg-yellow-600 transition-all ease-in-out duration-300 absolute bottom-0 w-full left-0 text-xl font-bold rounded-bl-lg rounded-br-lg py-2">
                        Buy now
                    </button>
                </div>
            </div>
