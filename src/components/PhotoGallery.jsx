...
function PhotoGallery() {
    ...
    return (
        <div 
            className="min-h-[90vh] pt-12 pl-4 md:pl-20 flex flex-col gap-10 text-white"
        ...
        >
            ...
            {isLoggedIn && role === "ADMIN" && (
                <Link to="/upload/image" className="text-white bg-orange-500 w-full md:w-[11%] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2">Upload Image</Link>
            )}
        </div>
    );
}
