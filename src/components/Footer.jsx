import logo from '../assets/rss-logo.jpg'
 ...
 function Footer() {
  return (
    <><section className="relative overflow-hidden bg-orange-50 py-8">
    <div className="container relative z-10 mx-auto px-4">
      <div className="-m-8 flex flex-wrap items-center justify-between">
        ...
        <div className="w-auto p-8">
          <ul className=" flex flex-wrap items-center sm:text-sm">
            <li className="p-5">
              <a className="font-medium text-orange-500 hover:text-gray-700" href="#">
                Privacy Policy
              </a>
            </li>
            <li className="p-5">
        ...
        <div className="w-auto p-8">
          <div className="-m-1.5 flex flex-wrap">
            <div className="w-auto p-1.5">
              <a href="#">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:bg-orange-400">
                  <svg
                    width="8"
                    height="14"
                    viewBox="0 0 8 14"
