...
function Loginpage() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-orange-100 " style={{ backgroundImage: `url(${updateImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <form
        noValidate
